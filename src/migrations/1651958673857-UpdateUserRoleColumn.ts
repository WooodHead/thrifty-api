...
export class UpdateUserRoleColumn1651958673857 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TYPE "public"."user_roles_enum" ADD VALUE IF NOT EXISTS 'super-admin'`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "user" ADD "roles" "public"."user_roles_enum"`);
