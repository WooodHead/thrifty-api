...
export class RemodeledUserToSavingsGroup1652364123359 implements MigrationInterface {
    name = 'RemodeledUserToSavingsGroup1652364123359'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "user_to_savings_group" ("userToSavingsGroup" uuid NOT NULL DEFAULT uuid_generate_v4(), "userId" uuid NOT NULL, "savingsGroupId" uuid NOT NULL, "dateAdded" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_96ac9c9fa4c994e6eb220f16831" PRIMARY KEY ("userToSavingsGroup"))`);
