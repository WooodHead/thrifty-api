...
export class AddedResetCodeEntity1667040654263 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "savings_group" ADD CONSTRAINT "UQ_4651f5fc023fd270366bb910661" UNIQUE ("groupName")`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "user_to_savings_group" ALTER COLUMN "contributedFunds" TYPE numeric`);
        await queryRunner.query(`ALTER TABLE "savings_group" DROP CONSTRAINT "UQ_4651f5fc023fd270366bb910661"`);
        await queryRunner.query(`ALTER TABLE "transaction" DROP COLUMN "accountId"`);
        await queryRunner.query(`ALTER TABLE "user" ADD "resetPassword" jsonb DEFAULT '{}'`);
        await queryRunner.query(`ALTER TABLE "transaction" ADD "toInternalAccountId" uuid`);
        await queryRunner.query(`ALTER TABLE "transaction" ADD "fromAccountId" uuid`);
