...
async function bootstrap() {
  const whitelist = [
    "http://localhost:3000",
    "https://api-thrifty.herokuapp.com",
  ];
  ...
  const config = new DocumentBuilder()
    ...
    .addServer(
      "https://api-thrifty.herokuapp.com/v1",
    ...
    .setDescription(
      "A Fictional Financial Services Provider which offers traditonal financial services and some other value-added services"
    )
    .setVersion("1.0")
    .addTag("Thrifty")
    .build();
